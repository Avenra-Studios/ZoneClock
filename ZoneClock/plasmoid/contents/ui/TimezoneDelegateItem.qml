...
Item {
    ...
    readonly property string displayTime: {
        ...
        // Plain offset arithmetic - deliberately not using
        // Intl.DateTimeFormat's timeZone option, which is not
        // reliably supported by Plasma's QML JS engine and was
        // producing "Invalid TZ" even for correct zones.
        return TimezoneData.formatTime(root.currentTime, root.timezone, root.format24h, root.showSeconds)
    }
